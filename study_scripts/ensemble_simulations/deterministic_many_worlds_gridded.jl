...
"""
This script produces a large set of deterministic runs, varying Tg, G0, sigma1 and re1.
Its results are used to produce a high-resolution resilience map (figure 4 in the paper).
"""
...
Arrow.write("data/deterministic_many_worlds_gridded.arrow", df)
println("Saved!")
