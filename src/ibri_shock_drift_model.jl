...
module ibri_shock_drift_model_mod
...
@parameters re₁ re₂ eb u σ₁ σ₂ G₀ G₁ Gₘ Tg η #earth system and climate 
export re₁, re₂, eb, u, σ₁, σ₂, G₀, G₁, Gₘ, Tg, η
...
eqs = [
    ...
    D(G)  ~ er₁*Y₁ + er₂*Y₂ - α + α*ct*gmax, # global externality.
