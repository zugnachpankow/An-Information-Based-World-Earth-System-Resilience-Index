...
It has "large" multiplicative noise (7.5% on average). 
...
println("Start runs...")
# .ensemble_sde_analysis_1 no. 1 is for Tg and G0, one of the most interesting combinations
...
Arrow.write("data/stochastic_many_worlds_mult_large_sigma.arrow", df)
println("Saved!")